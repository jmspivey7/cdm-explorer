  ...
  const roles = [
    {
      ...
      title: "Teacher",
      icon: BookOpen,
      subtitle: "Browse lessons, prepare Bible stories, get AI-powered teaching aids",
      accentColor: "se-blue",
    ...
    },
    {
      ...
      title: "Children",
      icon: Star,
      subtitle: "Explore Bible stories, play catechism games, practice verses",
    ...
    },
    {
      ...
      title: "Parents",
      icon: Users,
      subtitle: "At-home guides, family discussion starters, and prayer prompts",
